...
const ModalAddNew = ({setIsAddNewModalOpen, isAddNewModalOpen}) => {
  const handleOk = () => {
  ...
  const handleChange = value => {
    ...
    return (
        <>
        <Modal width={"60%"} title="Master Merchant Form" open={isAddNewModalOpen} onOk={handleOk} onCancel={handleCancel} okText="Save">
