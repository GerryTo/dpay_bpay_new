...
const ModalAccount = ({ isModalVisible, setIsModalVisible }) => {
    const handleOk = () => {
  ...
  return (
    <>
    <Modal width={"74%"} title="Login Form" open={isModalVisible} onOk={handleOk} onCancel={handleCancel} okText="Save">
